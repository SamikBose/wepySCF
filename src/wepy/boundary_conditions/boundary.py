...
class BoundaryConditions(object):
    ...
    def warping_field_names(self) -> tuple[str, str, str]:
        """Access the class level FIELDS constant for this record group."""
        return self.WARPING_FIELDS

    def warping_field_shapes(self) -> tuple[tuple[int], tuple[int], tuple[int]]:
        """Access the class level SHAPES constant for this record group."""
    ...
    def warping_record_field_names(self) -> tuple[str, str, str]:
        """Access the class level RECORD_FIELDS constant for this record group."""
...
class NoBC(BoundaryConditions):
    ...
    @classmethod
    def warping_discontinuity(cls, warping_record) -> bool:
...
class WarpBC(BoundaryConditions):
    ...
    def __init__(self, initial_states=None, initial_weights=None, **kwargs) -> None:
